...
/**
 * Created by patri_000 on 15.09.2016.
 */
public class CustomAdapter extends RecyclerView.Adapter{
    ...
    public CustomAdapter (ArrayList<String> mCurrentList, Context mContext) {
        super();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.img_row_layout, parent);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        try {
            TextView textRow = (TextView) v.findViewById(R.id.name);
